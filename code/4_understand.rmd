...
### Comparison of visit 2 by social support {.allowframebreaks}
...
### Comparison of visit 2 by vital exhaustion {.allowframebreaks}
...
### Comparison of visit 2 by anger {.allowframebreaks}
...
anger_v2 <-
  compareGroups(angergrp ~ DRINKER + SMOKER + BMI + HTN + CHD + DIABETES + STROKE, data = df) %>%
  createTable(., type = 1, show.n = FALSE, digits = 1, hide.no = c("Absent"))
...
### Comparison of visit 4 by anger {.allowframebreaks}
